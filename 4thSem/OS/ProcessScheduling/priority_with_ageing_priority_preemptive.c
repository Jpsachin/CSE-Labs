...
void priorityPreemptiveWithAgeing(int, int [], int[], int[], int[]);
...
int main() {
    ...
    priorityPreemptiveWithAgeing(n, burstTime, c_burstTime, arrivalTime, priority);
...
/**
 *  Priority Scheduling Preemptive With Arrival Time and Ageing Algorithm
 */
void priorityPreemptiveWithAgeing(int n, int b[], int c_b[], int a[], int p[]) {
