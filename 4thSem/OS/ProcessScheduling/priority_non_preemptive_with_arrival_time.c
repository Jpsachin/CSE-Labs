...
void priorityNonPreemptiveWithArrivalTime(int, int [], int[], int[], int[]);
...
int main() {
    ...
    int priority[NO_OF_PROCESSES] = {1, 2, 3, 4};
    ...
    priorityNonPreemptiveWithArrivalTime(n, burstTime, c_burstTime, arrivalTime, priority);
...
/**
 *  Priority Scheduling Non Preemptive With Arrival Time Algorithm
 */
void priorityNonPreemptiveWithArrivalTime(int n, int b[], int c_b[], int a[], int p[]) {
